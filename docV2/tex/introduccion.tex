...
\section{Motivación}
  ...
  esos máximos teóricos. Parece un cierto indicador de que la Lay de Moore tiene los días contados.
   ...
   mediante XML-RPC. Puntualizando de forma resumida:
    ...
    \begin{itemize}
      ...
      \item Repositorio de implementaciones de métodos posibilitando que el usuario aporte su propia implementación
            de los mismos.
      \item Uso de tecnologías SIMD si estas están disponibles.
      \item Soporte de múltiples arquitecturas, incluyendo de $64$ bits.
    ...
    Asimismo, se soportan los siguientes tipos de entidades, descritas con más detalle en el capítulo \ref{chap:tipos}:
      \begin{itemize}
        ...
        \begin{itemize}
          ...
          \end{itemize}
          \item Aritmética modular, $\mathbb{Z}_n$, $\mathbb{Z}_p$ y $\mathbb{Z}M_n$
          \begin{itemize}
        ...
        \item Polinomios.
          ...
          \begin{itemize}
            \item Sobre $\mathbb{Z}$.
            \item Sobre $\mathbb{R}$.
            \item Sobre $\mathbb{Z_n}$.
            \item Sobre $\mathbb{Z_p}$.
        ...
        \item Matrices.
          ...
          \begin{itemize}
            ...
            \item Sobre $\mathbb{R}$.
            \item Sobre $\mathbb{Z_n}$.
            \item Sobre elementos de un cuerpo finito $\GF$.
...
\section{El sistema de desarrollo}\label{sistemaDeDesarrollo}
  ...
  \begin{description}
    \item[Intel Core 2 Duo E6750 CPU] 
      Sistema multinúcleo en el que se han ejecutado tanto el desarrollo como las pruebas en paralelo. 
      %TODO: completar
  ...
  \begin{description}
    \item[Sistema operativo Linux.]
      ...
      \begin{description}
        \item[Bibliotecas del sistema.]  Implementación GNU de la biblioteca de C, versión 2.5.
    ...
    \subsubsection{Software libre}
      ...
      NTL (\url{http://www.shoup.net/ntl/}), Pari (\url{http://pari.math.u-bordeaux.fr/}) o GMP (\url{http://gmplib.org/}). 
      
      Por último, pero no por ellos menos importante, no debe descuidarse la vertiente filosófica de que,
      ...
      se analiza la problemática derivada del uso de software matemático de carácter propietario sus repercusiones.

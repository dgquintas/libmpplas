/*
 *  $Id: s.TextTestResult.h 1.3 02/06/11 16:15:41+02:00 gbevin@willow.uwyn.office $
 *
...
#ifndef QTUNIT_TEXTTESTRESULT_H
#define QTUNIT_TEXTTESTRESULT_H
...
namespace com_uwyn_qtunit
{
	...
	{
		REFERENCEOBJECT (TextTestResult)
	
	public:
				TextTestResult();
		virtual	~TextTestResult();
	...
	private:
		void	formatTest(const QString& rStatus, QString& rOutput, const TestDescription* const pTestDescription);
	};
}

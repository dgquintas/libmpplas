...
\section{Reales}
  ...
  \subsection{Cálculo de la raiz cuadrada}\label{tipos:sqrt}
  La función $\sqrt{A}$, puede definirse como las raices de la función $f(x) = x^2 - A$. Esto lleva a pensar
  inmediatamente en la utilización de un método iterativo para el cálculo de raices. Por ejemplo, el conocido
...
la división \emph{no} es una operación básica como erroneamente 

...
Constraints::must_have_base<S, MPPDataType > dummy2; (*@\label{algparent:MPPDataType}@*)
  ...
  implementacion, respectivamente). En sendas líneas se comprueba que el tipo de plantilla \texttt{S} 
...
El concepto de \textit{mock object}\footnote{podría traducirse como «objecto simulado», aunque incluso en la
  ...
  lo soporte es cuando el sistema no cuenta más que con una unidad de ejecución --CPU. En tal caso, el utilizar

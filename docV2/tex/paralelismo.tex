...
\section{Producto de enteros}\label{par:karatsubaZ}
 ...
 continuación la formulación de este método.
  ...
  ganancia del $30\%$ y una eficiencia de $\approx 0.15$. Debe tenerse en cuenta que el número
...
\section{Matrices}
  ...
  \subsection{Determinante}
    \subsubsection{Cálculo basado en la descomposición $LU$}\label{para:detViaLU}
      %TODO

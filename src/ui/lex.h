...
//    virtual void refresh(char *s) {str=(unsigned char *)s;i=0;return;};
...
//		int i;
	...
	public:
		inputString_t(string s) {str=s;i=0;};
    virtual void refresh(string s) {str=s;i=0;return;};
		virtual int getNextChar() 
			{if(str.c_str()[i]==0) return EOF;else return str[i++];};
		virtual ~inputString_t() {};
		virtual bool null() {return str.empty();};
	protected:
		string str;
		int i;

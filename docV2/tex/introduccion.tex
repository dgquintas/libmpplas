...
\section{Motivación}
  ...
  parencen ya cubiertos por numerosas soluciones, tanto libres como comerciales, puede parecer
  ...
  Pero no solo es el uso de paralelismo lo que caracteriza a esta biblioteca. Varias tecnologías y enfoques
  ...
  algebraica de los tipos, el reciente paradigma de la «programación orientada a aspectos» (AOP), \textit{mock
   ...
   en el capítulo \ref{chaper:tecnologias}.
    ...
    \item[Sistema operativo Linux.]
      ...
      \begin{description}
        \item[Librerías del sistema.] 
          Implementación GNU de la librería de C, versión 2.5.
        \item[Compiladores.]
        \begin{description}

...
\section{Estructura general de la biblioteca}
  ...
  \subsection{Información del sistema}\label{desc:systeminfo}
    ...
    \begin{itemize}
      ...
      \item Arquitectura para la cual se ha compilado la biblioteca. Ésta no tiene por que correspoder 
...
\begin{verbatim}
scons all enableDebug=1 enableRelease=0 optLevel=0 enableAOPProf=1 enableOpenmp=0
\end{verbatim}

...
\end{lstlisting}
  ...
  \end{quote}
  Por «expresión-constante» se refiere al tamaño que se asigna al vector estático en su 
...
\section{Programación orientada a aspectos (AOP)}\label{tech:aop}
  Este relativamente novedoso paradígma es considerado por algunos como una evolución 
...
\end{lstlisting}
  ...
  dicha sección exclusión mutua dentro de dicha sección crítica. Esto desemboca en el uso de \textit{candados}, de tal forma que cada vez
  ...
  sus comprobaciones extras y se asume la perdida de rendimiento «por necesidades del guión» o bien... volviendo atrás sobre nuestros pasos,

...
\section{Motivación}
  ...
  hasta un orden de magnitud más rapidas.
  ...
  Dado que el número método de incremento del rendimiento pasa a ser la explotación del paralelismo en vez de una mayor
  ...
  algebraica de los tipos, el reciente paradigma de la «programación orientada a aspectos» (AOP), \textit{mock
   ...
   mediante XML-RPC. Puntualizando de forma resumida:
    ...
    \begin{itemize}
      ...
      \item Uso de tecnologías SIMD si estas están disponibles --sección \ref{basico:cpusimd}--.

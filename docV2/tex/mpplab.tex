...
\section{Desarrollo}
  ...
  también potente, y muy versatil. Incluso, dado que descansa sobre el protocolo 
  ...
  \subsection{El servidor}
    ...
    \paragraph{Características}
      ...
      \subsubsection{Utilización de XML-RPC}
        ...
        necesario reestablecer ninguna conexión posteriormente, ya que cada una de las operaciones a
  ...
  \subsubsection{Gestión dinámica de datos de los clientes en tiempo de ejecución.}\ref{par:runtimeData}
    En el transcurso de una sesión de utilización del ciente, indudablemente se crearán
    ...
    de almacenaje y recuperación eficaz y eficiente que permita trabajar comodamente con
    ...
    y gestionar multiplies clientes de forma simultánea.
    ...
    de cliente (\texttt{clientId}) único. Mediante este identificador, se posibilita a 
...
\end{verbatim}
 ...
 La operación de acceso a una submatriz opera de la siguiente manera:
  \begin{description}
    ...
    se considerarán a $f$ como la última fila/columna. 
  \end{description}

/*
 *  $Id: s.Namespace.h 1.3 02/06/11 16:15:40+02:00 gbevin@willow.uwyn.office $
 *
...
#ifndef QTUNIT_NAMESPACE_H
#define QTUNIT_NAMESPACE_H

namespace com_uwyn_qtunit
{
	class ExampleTestCase;
	class ExampleTestSuite;
	class GuiErrorListItem;
	class GuiMainwindow;
	class GuiModuleListItem;
	class GuiPreferences;
	class GuiProjectFile;
	class GuiProjectInfo;
	class GuiProjectModules;
	class GuiProjectProperties;
	class GuiProjectWizard;
	class GuiSettings;
	class GuiTestListItem;
	class GuiTestResult;
	class GuiTestRunner;
